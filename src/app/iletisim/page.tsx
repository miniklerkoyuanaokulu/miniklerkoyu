      ...
      <div className="w-full bg-linear-to-b from-orange-600 via-orange-500 to-amber-500 relative">
        ...
        <main className="mx-auto max-w-6xl px-4 relative z-10">
          ...
          <section className="py-12 md:py-16">
            ...
            >
              <Card className="p-8 border-2 border-orange-200 hover:border-orange-300 hover:shadow-xl transition-all duration-300">
          ...
          <section id="on-kayit" className="pb-16">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <Card className="p-6 md:p-8 border-6 border-orange-200 shadow-xl">
                <PreRegistrationForm />
              </Card>
            </motion.div>
