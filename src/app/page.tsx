    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4">
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="p-6 h-full relative overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-emerald-100/50 border-2 hover:border-emerald-200">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  <div className="flex items-center gap-3">
                    <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-100 to-green-100 text-emerald-600 group-hover:from-emerald-500 group-hover:to-green-500 group-hover:text-white transition-all duration-300 group-hover:scale-110 group-hover:rotate-6">
            ...
            >
              <Card className="p-6 h-full relative overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-cyan-100/50 border-2 hover:border-cyan-200">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  <div className="flex items-center gap-3">
                    <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-100 to-blue-100 text-cyan-600 group-hover:from-cyan-500 group-hover:to-blue-500 group-hover:text-white transition-all duration-300 group-hover:scale-110 group-hover:rotate-6">
            ...
            >
              <Card className="p-6 h-full relative overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-amber-100/50 border-2 hover:border-amber-200">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  <div className="flex items-center gap-3">
                    <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-amber-100 to-orange-100 text-amber-600 group-hover:from-amber-500 group-hover:to-orange-500 group-hover:text-white transition-all duration-300 group-hover:scale-110 group-hover:rotate-6">
        ...
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-purple-100/90 via-pink-100/80 to-blue-100/90" />
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-12 md:grid-cols-[1.1fr_0.9fr] md:py-16">
            <motion.div {...fadeUp}>
              <Card className="p-8 relative overflow-hidden border-2 border-purple-100 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-100/50 to-pink-100/50 rounded-full blur-3xl" />
                <div className="relative z-10">
                  ...
                  <div className="mt-8 flex gap-3">
                    <Link
                      ...
                      className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 text-sm font-medium text-white shadow-md hover:shadow-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300"
                    >
                      Detaylı Akış
                      <svg
                    ...
                    <div className="inline-flex items-center gap-2 text-sm text-purple-700 font-medium">
                      <div className="flex -space-x-2">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 border-2 border-white flex items-center justify-center text-white text-xs">
                          🌱
                        </div>
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 border-2 border-white flex items-center justify-center text-white text-xs">
                          🎨
                        </div>
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-amber-400 to-orange-400 border-2 border-white flex items-center justify-center text-white text-xs">
                          🎭
                        </div>
                      </div>
        ...
        <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          ...
          <div className="mt-8 grid grid-cols-2 gap-5 sm:grid-cols-3 md:grid-cols-6">
            {[
              ...
              >
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${it.bgLight} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  />
                  <div className="relative z-10">
                    <div
                      className={`mx-auto mb-3 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${it.color} text-white shadow-md group-hover:shadow-lg group-hover:scale-110 group-hover:rotate-12 transition-all duration-300`}
                    >
          ...
          <div className="mt-8 flex flex-wrap gap-3 items-center justify-center">
            <Link
              ...
              className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3 text-sm font-medium text-white shadow-md hover:shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300"
            >
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 -z-20 bg-gradient-to-br from-green-50/80 via-blue-50/60 to-purple-50/80" />
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-green-200/20 to-blue-200/20 rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-purple-200/20 to-green-200/20 rounded-full blur-3xl" />

          {/* subtle noise */}
          <div className="pointer-events-none absolute inset-0 -z-10 opacity-20 [background:radial-gradient(circle_at_center,#000_0.5px,transparent_0.5px)] [background-size:20px_20px]" />
          ...
          <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
              ...
              {[
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${item.colorFrom}55, ${item.colorTo}55)`,
                    }}
                  >
                    {/* card */}
                    <div
                      className="relative h-48 md:h-64 overflow-hidden rounded-[1rem] border border-white/40 bg-white/60 backdrop-blur-md 
                    ...
                    >
                      <Image
                        src={`/images/home/galeri-${item.id}.png`}
                        alt={`Galeri görseli #${item.id}`}
                        fill
                      ...
                      {/* top gradient sheen */}
                      <div className="pointer-events-none absolute inset-0 bg-gradient-to-tr from-white/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      ...
                      <Link
                        href="/medya"
                        aria-label={`Galeri ${item.id} detaylarını gör`}
            ...
            >
              <Link
                href="/medya"
                className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#ff7a00] to-[#ff477e] 
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 md:py-20">
          ...
          >
            <Card className="relative overflow-hidden border-2 border-primary/20 shadow-2xl bg-white">
              ...
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-secondary/10 to-primary/10 rounded-full blur-3xl" />
              ...
              <div className="relative z-10 flex flex-col items-center justify-between gap-8 p-8 md:flex-row md:p-12 lg:p-16">
                ...
                <div className="flex flex-col gap-4 items-center md:items-end">
                  <Link
                    ...
                    className="group relative inline-flex items-center gap-3 px-8 py-4 text-lg font-semibold text-white rounded-xl bg-gradient-to-r from-primary to-accent shadow-lg hover:shadow-xl hover:from-primary/90 hover:to-accent/90 transition-all duration-300 overflow-hidden"
                  >
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <div className="flex -space-x-2">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-400 to-rose-400 border-2 border-white shadow-md flex items-center justify-center text-white font-bold">
                        👶
                      </div>
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 border-2 border-white shadow-md flex items-center justify-center text-white font-bold">
                        👧
                      </div>
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 to-emerald-400 border-2 border-white shadow-md flex items-center justify-center text-white font-bold">
                        👦
                      </div>
                    </div>
