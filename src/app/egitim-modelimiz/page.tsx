              ...
              <div className="mt-8 grid md:grid-cols-[1.1fr_0.9fr] gap-8 items-start">
                ...
                <motion.div {...fadeUp} className="prose max-w-none">
                  ...
                  <p>
                    ...
                    dersleri, etkinlikler ve oyun gibi aktivitelere katılırlar.
                  </p>
                  <p>
                    Uyku saati ve derslerin ardından ikindi kahvaltısında mutfak
                    annemizin ellerinden çıkan taze ikindi kahvaltılarını
                    yaparlar. Günün her saati, çocukların hayal gücünü
                    destekleyecek bir etkinlik içerir.
                  </p>
                  <p>
                    Günlük planlarımız mevsimlerle, hava koşullarıyla ve
                    çocukların ilgileriyle birlikte şekillenir. Kimi gün bahçede
                    hikâye zamanı, kimi gün bahçede yoga, kimi gün de sessizce
                    resim yapma alanı olur.
                  </p>
                  <p>
              ...
              <Card className="p-8 h-full relative overflow-hidden group cursor-pointer border-2 border-blue-200 hover:border-blue-300 transition-all duration-300 hover:shadow-xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-700 leading-relaxed text-center">
                    Çocukların gelişimini ailelerle paylaştığımız özel sunumlar
                  </p>
                </div>
              </Card>
            </motion.div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          Düzenli görüşmelerle ailelerin gözlem ve endişelerini
                          dinler, birlikte çözüm üretiriz
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          Gelişim yolculuğu kapsamlı raporlarla bütüncül olarak
                          sunulur
                        </p>
                      </div>
                    </div>
